<template>
  <div class="page">
    ...
    <el-dialog v-model="dialog.visible" :title="dialog.isEdit ? '编辑复审无效' : '新增复审无效'" width="700px" destroy-on-close>
...
const form = reactive({
  ...
  applicationNo: '', patentName: '', applicant: '', sponsor: '',
  officialFee: '', paymentDate: ''
})
